...
<p align="center"><em>รูปที่ 2.1 กราฟแสดงข้อมูลเปรียบเทียบระหว่างจำนวนผู้ได้เก้าอี้ สส.แบ่งเขต (Number of Winner(seat)) กับสัดส่วนการได้เก้าอี้ สส (Percentage) โดยแบ่งตาม big house status </em></p>

จะพบว่า สส.แบ่งเขตที่ได้เก้าอี้ทั้งหมดในประเทศไทยซึ่งเราได้ทำการแบ่งวิเคราะห์เป็น 2 กลุ่มคือ สส.แบ่งเขตที่เป็นบ้านใหญ่และ สส.แบ่งเขตที่ไม่ได้เป็นบ้านใหญ่ จากรูปที่ 2.1 จะพบว่าถ้านับตามจำนวนเก้าอี้ผู้ชนะ สส.แบ่งเขตเราจะเห็นว่า สส. ที่ไม่ได้เป็น bighouse มีจำนวนเก้าอี้มากกว่าถึง 146 เก้าอี้ แต่ถ้าเรามองในมุมมองของสัดส่วนของผู้ที่ได้เก้าอี้ในแต่ละกลุ่มเราจะพบว่าจำนวนของผู้สมัคร สส ที่เป็นบ้านใหญ่นั้นมีสัดส่วนการได้เก้าอี้ต่อจำนวนบ้านใหญ่ทั้งหมดถึง 57.21% ซึ่งแตกต่างจาก สส ที่ไม่ได้เป็นบ้านใหญ่ที่ได้เก้าอี้ที่ได้สัดส่วนที่ 8.35% จึงทำให้เห็นถึงอิทธิพลของบ้านใหญ่ที่ส่งผลต่อการได้เก้าอี้ สส.แบ่งเขตเพราะแม้ว่าจะเป็นคนกลุ่มน้อยแต่ก็เป็นกลุ่มที่สามารถดึงเก้าอี้ไปได้ถึง 127 ที่นั่ง

<p align="center">
  <img src="images/img_2_2.png" alt="รูปที่ 2.2" width="1000">
</p>

<p align="center"><em>รูปที่ 2.2 กราฟการวิเคราะห์ผลการเลือกตั้งจำแนกตามภูมิภาคและสถานะบ้านใหญ่ (Big House) ประกอบด้วย (บนซ้าย) จำนวนสส.แบ่งเขตที่ได้เก้าอี้แยกตามสถานะบ้านใหญ่, (บนขวา) สัดส่วนสส.แบ่งเขตที่ได้เก้าอี้ที่เป็นบ้านใหญ่ต่อ สส.แบ่งเขตที่ได้เก้าอี้ทั้งหมดในแต่ละภูมิภาค, (ล่างซ้าย) การเปรียบเทียบระหว่างจำนวน สส.แบ่งเขตทั้งหมดและ สส.แบ่งเขตที่ได้เก้าอี้ที่เป็นบ้านใหญ่ และ (ล่างขวา) อัตราการได้เก้าอี้ สส.แบ่งเขต(Win Rate) ของผู้สมัครกลุ่มบ้านใหญ่ </em></p>
...
<p align="center">
  <img src="region_tables/Western.png" alt="รูปที่ 2.6" width="500">
</p>
