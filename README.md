...
<p align="center"><em>รูปที่ 2.1 กราฟแสดงข้อมูลเปรียบเทียบระหว่างจำนวนผู้ได้ที่นั่ง สส.แบ่งเขต (Number of Winner(seat)) กับสัดส่วนการได้ที่นั่ง สส (Percentage) โดยแบ่งตาม big house status </em></p>

จากการดูข้อมูลจำนวน สส.แบ่งเขตที่ได้ที่นั่งทั้งหมดในประเทศไทยซึ่งเราได้ทำการแบ่งวิเคราะห์เป็น 2 กลุ่มคือ สส.แบ่งเขตที่เป็นบ้านใหญ่และ สส.แบ่งเขตที่ไม่ได้เป็นบ้านใหญ่ จะพบว่าจากรูปที่ 2.1 ถ้านับจำนวนที่นั่งผู้ชนะ สส.แบ่งเขตเราจะเห็นว่า สส. ที่ไม่ได้เป็น bighouse มีจำนวนที่นั่งมากกว่าถึง 146 ที่นั่ง แต่ถ้าเรามองในมุมมองของสัดส่วนของผู้ที่ได้ที่นั่งในแต่ละกลุ่มเราจะพบว่าจำนวนของผู้สมัคร สส ที่เป็นบ้านใหญ่นั้นมีสัดส่วนการได้ที่นั่งต่อจำนวนบ้านใหญ่ทั้งหมดถึง 57.21% ซึ่งแตกต่างจาก สส ที่ไม่ได้เป็นบ้านใหญ่ที่ได้ที่นั่งที่ได้สัดส่วนที่ 8.35% จึงทำให้เห็นถึงอิทธิพลของบ้านใหญ่ที่ส่งผลต่อการได้ที่นั่ง สส.แบ่งเขตเพราะแม้ว่าจะเป็นคนกลุ่มน้อยแต่ก็เป็นกลุ่มที่สามารถดึงที่นั่งไปได้ถึง 127 ที่นั่ง
...
จากรูปที่ 2.3 จะพบว่าแต่ละพรรคมีสัดส่วนของ สส.แบ่งเขตบ้านใหญ่เยอะที่ได้ที่นั่งมากกว่า 30 % ถึง 4 พรรค และสูงสุดที่ 42.5% ที่เป็นของพรรคภูมิใจไทย และรองลงมาเป็นพรรคเพื่อไทยที่มีสัดส่วนของ สส.แบ่งเขตบ้านใหญ่เท่ากับ 41.4% ซึ่งจะมองได้ว่าบ้านใหญ่มีอิทธิพลต่อคะแนนของพรรคอย่างเห็นได้ชัด ยกเว้นพรรคประชาชนที่มีสัดส่วนของ สส.แบ่งเขตบ้านใหญ่ที่ต่ำ และถ้าดูในเรื่องของจำนวนของ สส.แบ่งเขตบ้านใหญ่ที่ได้ที่นั่งในแต่ละพรรคจะพบว่าในพรรคภูมิใจมีสูงถึง 74 คนในพรรคเดียวซึ่งมากกว่า สส.แบ่งเขตที่ได้ที่นั่งทั้งหมดของพรรคเพื่อไทย พรรคกล้าธรรม พรรคประชาธิปัตย์อย่างชัดเจน

<p align="center">
  <img src="images/img_2_4.png" alt="รูปที่ 2.4" width="1000">
</p>

<p align="center"><em>รูปที่ 2.4 กราฟแสดงจำนวนของ สส.แบ่งเขตที่ได้ที่นั่งโดยแบ่งเป็น สส.แบ่งเขตบ้านใหญ่และ สส.แบ่งเขตที่ไม่ได้เป็นบ้านใหญ่ของแต่ละพรรคในแต่ละภูมิภาค</em></p>

<p align="center">
  <img src="region_tables/Central.png" alt="รูปที่ 2.5" width="500">
</p>

<p align="center"><em>รูปที่ 2.5 กราฟแสดงจำนวนของ สส.แบ่งเขตที่ได้ที่นั่งโดยแบ่งเป็น สส.แบ่งเขตบ้านใหญ่และ สส.แบ่งเขตที่ไม่ได้เป็นบ้านใหญ่ของภาคกลาง (Central)</em></p>

<p align="center">
  <img src="region_tables/Northern.png" alt="รูปที่ 2.6" width="500">
</p>
<p align="center"><em>รูปที่ 2.6 กราฟแสดงจำนวนของ สส.แบ่งเขตที่ได้ที่นั่งโดยแบ่งเป็น สส.แบ่งเขตบ้านใหญ่และ สส.แบ่งเขตที่ไม่ได้เป็นบ้านใหญ่ของภาคเหนือ (Northern)</em></p>

<p align="center">
  <img src="region_tables/Western.png" alt="รูปที่ 2.7" width="500">
</p>
<p align="center"><em>รูปที่ 2.7 กราฟแสดงจำนวนของ สส.แบ่งเขตที่ได้ที่นั่งโดยแบ่งเป็น สส.แบ่งเขตบ้านใหญ่และ สส.แบ่งเขตที่ไม่ได้เป็นบ้านใหญ่ของภาคตะวันตก (Western)</em></p>

จากรูปที่ 2.4 เราจะเห็นว่าพรรคภูมิใจไทยมี สส.แบ่งเขตบ้านใหญ่ค่อนข้างมากในภูมิภาคตะวันออกเฉียงเหนือ (Northeastern) และภาคกลาง (Central) ซึ่งแสดงให้เห็นถึงการพึ่งพาเครือข่ายบ้านใหญ่อย่างชัดเจนโดยเฉพาะในภาคกลาง และยังมีสัดส่วนผู้ชนะที่เป็นบ้านใหญ่เท่ากับครึ่งหนึ่งหรือมากกว่าครึ่งของจำนวนที่นั่งที่พรรคที่ได้รับ ซึ่งจะประกอบไปด้วย ภาคกลางที่มีสัดส่วน 55.56% (จากรูปที่ 2.5) ภาคเหนือที่มีสัดส่วน 66.67% (จากรูปที่ 2.6) ภาคตะวันตกที่มีสัดส่วน 50% (จากรูปที่ 2.7) ในส่วนของพรรคเพื่อไทยจะมีจำนวนบ้านใหญ่เยอะอยู่ที่ภาคตะวันออกเฉียงเหนือ และจะเห็นได้ชัดว่าจำนวนที่นั่งที่มาจากภาคกลางและภาคตะวันออกมาจากบ้านใหญ่ทั้งสิ้น
