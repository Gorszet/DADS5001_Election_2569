...
<p align="center"><em>รูปที่ 1.1 กราฟแสดงจำนวนผู้ใช้สิทธิเลือกตั้ง (Turnout) และไม่มาใช้สิทธิเลือกตั้ง (No Show) และจำนวนบัตรดี (Valid) บัตรเสีย (Invalid) และไม่ประสงค์ลงคะแนน (No Vote) ปี 2569
...
<p align="center"><em>รูปที่ 1.2 กราฟแสดงข้อมูลเปรียบเทียบระหว่างผู้ใช้สิทธิเลือกตั้ง (Turnout) และไม่มาใช้สิทธิเลือกตั้ง (No Show) ระหว่างปี 2566 และปี 2569
...
<p align="center"><em>รูปที่ 1.3 กราฟแสดงข้อมูลเปรียบเทียบจำนวนบัตรดี (Valid) บัตรเสีย (Invalid) และไม่ประสงค์ลงคะแนน (No Vote) ระหว่างปี 2566 และปี 2569
...
<p align="center"><em>รูปที่ 1.4 กราฟแสดง A) ผลรวมคะแนนเสียงของ สส.บัญชีรายชื่อ (Party-list MPs) แบ่งตามพรรค และ B) ผลรวมคะแนนเสียงของ สส.แบ่งเขต (Constituency MPs) เลือกตั้งแบ่งตามพรรค
...
<p align="center"><em>รูปที่ 1.5 กราฟแสดงการเปรียบเทียบระหว่างจำนวนที่นั่ง สส.แบ่งเขต (Constituency MPs) และ สส.บัญชีรายชื่อ (Party-list MPs)
...
<p align="center"><em>รูปที่ 1.6 กราฟแสดงเมทริกซ์การกระจายตัวของที่นั่ง สส. แบ่งเขตรายภูมิภาค
...
<p align="center"><em>รูปที่ 1.7 แผนที่พรรคการเมืองที่ได้คะแนนบัญชีรายชื่อสูงสุดรายจังหวัด
...
<p align="center"><em>รูปที่ 1.8 สัดส่วนคะแนนที่ได้ผู้แทน (Used Vote) เทียบกับ คะแนนที่สูญเปล่า (Wasted Vote)
