...
<p align="center"><em>รูปที่ 1.1 กราฟแสดงข้อมูลเปรียบเทียบระหว่างจำนวนผู้ได้เก้าอี้ สส (Number of Winner(seat)) กับสัดส่วนการได้เก้าอี้ สส (Percentage) โดยแบ่งตาม big house status
...
<p align="center"><em>รูปที่ 1.3 กราฟแสดงสัดส่วนของจำนวน สส บ้านใหญ่ต่อจำนวน สส ทั้งหมดในพรรคที่เป็น Top 5 ในการเลือกตั้ง สส แบ่งเขต
...
<p align="center"><em>รูปที่ 1.4 กราฟแสดงจำนวนของ สส ที่ได้เก้าอี้โดยแบ่งเป็น สส บ้านใหญ่และ สส ที่ไม่ได้เป็นบ้านใหญ่ของแต่ละพรรคในภูมิภาคต่างๆ
